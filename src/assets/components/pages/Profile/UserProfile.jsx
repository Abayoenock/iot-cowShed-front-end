  ...
  return (
    <>
      ...
      <div className=" container mx-auto px-2 flex  relative w-full  mt-2 outline-4 justify-center">
        <button
          className=" absolute top-2 right-6 bg-green-700 p-2 px-3 text-white text-sm rounded-sm transition-all duration-300 hover:translate-x-1 hover:bg-green-900"
          onClick={handleClick}
        >
          <FontAwesomeIcon icon={faKey} className="mr-2" /> Change password
        </button>
        <div className=" mt-[90px] w-full md:w-[60%] relative flex flex-col p-2 gap-4 justify-center items-center border-[1px] border-dotted border-green-300 ">
          <form
            method="post"
            id="profileForm"
            ...
            <div className="w-fit  absolute left-4 -top-[75px]">
              <div className="flex mb-4 w-fit  ">
                {!selectedImage && (
                  <label
                    htmlFor="image"
                    className=" cursor-pointer transition-all duration-300 hover:bg-green-100 relative mr-2 w-[150px] h-[150px] border-[1px] border-dashed border-green-200 flex items-center justify-center flex-col"
                  >
                    {" "}
                    <ImageWithBlurhash
                      imageUrl={
                    ...
                    />
                    <p className=" text-xs p-2 w-full  text-white absolute  bottom-0  left-0  bg-green-700 bg-opacity-50 backdrop-blur-sm h-fit transition-all duration-300 group-hover:-translate-y-[100%]  ">
                ...
                {selectedImage && (
                  <div className=" relative w-[150px] h-fit border-[1px] border-dashed border-green-200 p-4 py-2">
            ...
            <div className=" w-full grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 mt-[150px]">
              ...
              <div className="w-full flex justify-end col-span-2 ">
                <button
                  ...
                  }  focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm w-fit sm:w-auto px-5 py-2.5 text-center  `}
                >
                  {!isSubmit ? (
                    "Update"
                  ) : (
      ...
      <Modal
        ...
        sx={{
          backgroundColor: "rgba(37,255,25,0.1)",
      ...
      >
        <form
          ...
          className=" relative w-[80%] md:w-1/2  p-4 shadow-lg rounded-md border-[1px] border-green-100 py-8 bg-white   "
        >
          <FontAwesomeIcon
            icon={faXmark}
          ...
          <div className="w-full flex justify-end ">
            <button
              type="submit"
              className="  text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm w-fit sm:w-auto px-5 py-2.5 text-center d"
            >
              Update
            </button>
          </div>
