...
const UserList = () => {
      ...
      cell: (row) => (
        <div className="flex gap-2">
          <NavLink to={`../edit-user/${row["userID"]}`}>
            <FontAwesomeIcon
              icon={faEdit}
              className=" p-2 px-3 rounded-sm bg-green-600 cursor-pointer text-white transition-all duration-300 hover:scale-105 hover:bg-green-700"
            />
          </NavLink>
  ...
  return (
    <>
      ...
      {!isLoading && (
        <div className="w-full  px-8 no-header mt-[20px]">
          <NavLink to={"./new-user"}>
            {" "}
            <button className="bg-green-700 p-2 px-3 text-white text-sm rounded-sm transition-all duration-300 hover:-translate-x-1 hover:bg-green-800 mb-[30px]">
          ...
          >
            ...
            <DialogActions>
              ...
              <button
                onClick={deleteUser}
                className="border-none bg-green-700 p-2 px-3 text-white text-sm font-semibold rounded-sm transition-all duration-300 hover:bg-green-800 "
              >
                Confirm
              </button>
            </DialogActions>
